...
import com.rpg.game.pathfinding.ClosestHeuristic;
...
public class AStarPathFinder implements PathFinder {
	...
	public void SetMap(TileBasedMap newmap){
		this.map = newmap;
	...
	public Path findPath(int[] start, int[] end) {
		return findPath(start[0], start[1], end[0], end[1]);
	}
	
	public Path findPath(int sx, int sy, int tx, int ty) {
		return this.findPath(null, sx, sy, tx, ty);
	}
	...
	public Path findPath(Mover mover, int sx, int sy, int tx, int ty) {
		...
		while (target != null && target != nodes[sx][sy]) {
